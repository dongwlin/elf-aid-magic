...
func Createrequest(logger *zap.Logger, action, status, message string, data map[string]interface{}) Message {
	return createMessage(logger, TypeRequest, action, "", status, message, data)
}
